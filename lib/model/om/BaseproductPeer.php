...
abstract class BaseproductPeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Price', 'Quantity', 'Image', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'price', 'quantity', 'image', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::PRICE, self::QUANTITY, self::IMAGE, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'PRICE', 'QUANTITY', 'IMAGE', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'price', 'quantity', 'image', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Price' => 2, 'Quantity' => 3, 'Image' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'price' => 2, 'quantity' => 3, 'image' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::PRICE => 2, self::QUANTITY => 3, self::IMAGE => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'PRICE' => 2, 'QUANTITY' => 3, 'IMAGE' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'price' => 2, 'quantity' => 3, 'image' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
