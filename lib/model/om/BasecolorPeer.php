...
abstract class BasecolorPeer {
	...
	const CLASS_DEFAULT = 'lib.model.color';
	...
	/**
	 * An identiy map to hold any loaded instances of color objects.
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BasecolorPeer', $criteria, $con);
		}
	 ...
	 *
	 * @param      color $value A color object.
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = colorPeer::getOMClass(false);
	...
	{
		return $withPrefix ? colorPeer::CLASS_DEFAULT : colorPeer::OM_CLASS;
	}
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BasecolorPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
